...
w("table3.md", f"""# Table 3. Where the exit gap lives: female-founded deals
...
| Reference: sample-end horizon, deals through 2017-10, firm × year × sector (Table 9 Panel E) | {e55['B_exit_ever_2017']['cell_cat']['n_mixed_cells']:,} / {e55['B_exit_ever_2017']['cell_cat']['n_deals_mixed']:,} | {e55['B_exit_ever_2017']['cell_cat']['n_multi_round_cells']:,} / {e55['B_exit_ever_2017']['cell_cat']['n_deals_multi']:,} | {e55['B_exit_ever_2017']['cell_cat']['n_cells_var_pos']} | {e55['B_exit_ever_2017']['cell_cat']['dilution_share_sxx_single_round']:.2f} | {e55['B_exit_ever_2017']['cell_cat']['beta_full_pp']:+.2f} | {e55['B_exit_ever_2017']['cell_cat']['beta_multi_pp']:+.2f} | {raw(e55['B_exit_ever_2017']['cell_cat']['ci_multi_pp'], 2)} | {e55['B_exit_ever_2017']['cell_cat']['mde80_multi_pp']:.2f}; {e55['B_exit_ever_2017']['cell_cat']['mde80_multi_sd']:.2f} | {e55['B_exit_ever_2017']['cell_cat']['placebo_p95_multi_pp']} |
...
w("table4.md", f"""# Table 4. Conditional on composition: the within-partner outcome test and the covariate-adjusted battery (NA+EU)
...
| + pre-assignment company characteristics | {e54['A_exit3']['V5_company_controls']['ffp']['coef']*100:+.2f} | {pp(e54['A_exit3']['V5_company_controls']['ffp']['ci95'])} | {e54['A_exit3']['V5_company_controls']['ffp']['mde80']*100:.2f} | {e54['A_exit3']['V5_company_controls']['ffp']['beta_std']:+.3f} | {'yes' if e54['A_exit3']['V5_company_controls']['ffp']['within_pm0.05'] else 'no'} | {e54['A_exit3']['V5_company_controls']['ff']['coef']*100:+.2f} | {pp(e54['A_exit3']['V5_company_controls']['ff']['ci95'])} | {e54['A_exit3']['V5_company_controls']['n']:,} / {e54['A_exit3']['V5_company_controls']['n_partners']:,} ({e54['A_exit3']['V5_company_controls']['n_female_partners']}) |
...
*Deal controls: round size, company age, prior rounds, syndicate size, co-investor experience (all at deal date). Identifying base of the hazard (share of cell–year groups that are co-attributions on a single round; gap on multi-round groups): Table 9, Panel E. The deal-fixed continuation margin is Table 10, Panel A. Sources: P001-12, P001-13, P001-14, P001-03 (MDEs), P001-50 (identifying base).*
""")

e80, e81 = i80["estimates"], i81["estimates"]
w("table5.md", f"""# Table 5. The stage tilt and its origins
| | Estimate | 95% CI |
|---|---|---|
...
w("table6.md", f"""# Table 6. Partner turnover and deal composition: deal-level stacked event studies (NA+EU)
...
|---|---|---|
| Composition-adjusted percentile (given raw) | {e18['beta_adj_given_raw'][0]:+.2f} | {raw(e18['beta_adj_given_raw'][1],2)} |
| Raw percentile (given adjusted) ≡ composition component | {e18['beta_raw_given_adj'][0]:+.2f} | {raw(e18['beta_raw_given_adj'][1],2)} |
...
w("table8.md", f"""# Table 8. The female-partner channel along the financing ladder (NA+EU)
...
|---|---|---|
| Baseline (canonical: P001-06) | {e6['diff_slope'][0]:+.2f} | {pp(e6['diff_slope'][1])} |
...
w("table9.md", f"""# Table 9. Robustness and measurement diagnostics
...
| Annual hazard gap, all cells (pp/yr); within ±25% of the {e50['A_cells']['base_hazard']*100:.2f}% base | {e50['B_hazard_gap']['full']['coef_pp']:+.3f} {raw(e50['B_hazard_gap']['full']['ci95_pp'],2)}; {'yes' if e50['B_hazard_gap']['full']['within_quarter_of_base'] else 'no'} |
...
w("table10.md", f"""# Table 10. Additional designs: the deal held fixed, balance, movers, absences, and the financing pipeline
...
|---|---|---|---|---|---|
| Any-female attribution (baseline; re-estimated) | {e51['A_baseline']['fp']['coef']*100:+.2f} | {pp(e51['A_baseline']['fp']['ci95'])} | {e51['A_baseline']['fp']['mde80']*100:.2f} | {'yes' if e51['A_baseline']['fp']['within_pm0.05'] else 'no'} | {e51['A_baseline']['n']:,} / {e51['A_baseline']['n_clusters']:,} |
| Female-only attribution (investor rows attributed to both a woman and a man dropped: {e51['B_treatment_definition']['n_mixed_attr_rows_dropped']} rows) | {e51['B_treatment_definition']['female_only']['fp']['coef']*100:+.2f} | {pp(e51['B_treatment_definition']['female_only']['fp']['ci95'])} | {e51['B_treatment_definition']['female_only']['fp']['mde80']*100:.2f} | {'yes' if e51['B_treatment_definition']['female_only']['fp']['within_pm0.05'] else 'no'} | {e51['B_treatment_definition']['female_only']['n']:,} / {e51['B_treatment_definition']['female_only']['n_clusters']:,} |
| Any-female attribution, 2,000 bootstrap draws | {e59['E_within_round_2000']['any_female']['fp']['coef']*100:+.2f} | {pp(e59['E_within_round_2000']['any_female']['fp']['ci95'])} | {e59['E_within_round_2000']['any_female']['fp']['mde80']*100:.2f} | {'yes' if e59['E_within_round_2000']['any_female']['fp']['within_pm0.05'] else 'no'} | {e59['E_within_round_2000']['any_female']['n']:,} / {e59['E_within_round_2000']['any_female']['n_clusters']:,} |
| Female-only attribution, 2,000 bootstrap draws | {e59['E_within_round_2000']['female_only']['fp']['coef']*100:+.2f} | {pp(e59['E_within_round_2000']['female_only']['fp']['ci95'])} | {e59['E_within_round_2000']['female_only']['fp']['mde80']*100:.2f} | {'yes' if e59['E_within_round_2000']['female_only']['fp']['within_pm0.05'] else 'no'} | {e59['E_within_round_2000']['female_only']['n']:,} / {e59['E_within_round_2000']['female_only']['n_clusters']:,} |
...
fig.tight_layout()
fig.savefig(os.path.join(OUT_F, "fig1_ladder.png"))
...
ax.axhline(0, color="grey", lw=0.8)
ax.axhspan(e11["join"][1][0] * 100, e11["join"][1][1] * 100, color="#4C72B0", alpha=0.10,
           label="Post-mean 95% CI")
...
fig.tight_layout()
fig.savefig(os.path.join(OUT_F, "fig2_eventstudy.png"))
...
ax.set_title("Figure 3. The female-partner channel narrows along the ladder")
ax.legend(fontsize=8)
fig.tight_layout()
fig.savefig(os.path.join(OUT_F, "fig3_channel.png"))
print("figures: fig1-3 saved")
